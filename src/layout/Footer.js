      ...
      <div className="footer-content">
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="/">
              ...
              <img src="https://cdn-icons-png.flaticon.com/128/9729/9729149.png" width={70} alt="logo" />
            </a>
          </div>
          <div className="footer-menu">
            <h2 className="footer-menu-name">Stock</h2>
            <ul id="menu-get-started" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="/ListOrder">List Order</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="/ListTrade">List Trade</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="footer-menu">
            <ul id="menu-legal" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-170434">
                <a href="/CurrentStock">Current Stock</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="/order/Sell">Make Order</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="/Deposit">Balance</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="footer-content-column">
          ...
          <div className="footer-menu">
            ...
            <ul id="menu-quick-links" className="footer-menu-list">
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a href="https://www.google.com/maps/place/Institute+of+Technology+of+Cambodia/@11.5703975,104.895897,17z/data=!3m1!4b1!4m6!3m5!1s0x3109517388680e15:0x63057e6682968f5!8m2!3d11.5703975!4d104.8980857!16zL20vMDZ5dmhz">
                  Institute Technology of Cambodia</a>
              </li>
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a  href="https://www.google.com/maps/place/CSX+Building,+St+Preah+Mohaksat+Treiyani+Kossamak,+Phnom+Penh/@11.574244,104.922575,17z/data=!3m1!4b1!4m6!3m5!1s0x31095145049886eb:0xf13a079b7458ee08!8m2!3d11.574244!4d104.9247637!16s%2Fg%2F12hxgdbjj">
                CSX Building</a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <a className="footer-call-to-action-mail mail" href="mailto:ganakoeng1111@gmail.com" target="_self"> Get in Touch </a>
        ...
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link linkedin" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM">
          ...
          <a className="footer-social-link twitter" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM">
          ...
          <a className="footer-social-link youtube" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM">
          ...
          <a className="footer-social-link github" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM" target="_self"> ©2020. | Designed By: Pooja Nahelia. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>

    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link linkedin" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM" target="_blank">
          ...
          <a className="footer-social-link twitter" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM" target="_blank">
          ...
          <a className="footer-social-link youtube" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM" target="_blank">
          ...
          <a className="footer-social-link github" href="https://www.youtube.com/watch?v=fDg3PTQ1tzM" target="_blank">
